...
void testMergePrioQueue(){
    cout << "Test mergePrioQueue" << endl;
    PriorityQueue pq1([](TPriority p1, TPriority p2) { return p1 < p2; });
    PriorityQueue pq2([](TPriority p1, TPriority p2) { return p1 < p2; });
    pq1.push(1, 1);
    pq1.push(3, 3);
    pq1.push(5, 5);
